...
class _AdminSettingsScreenState extends State<AdminSettingsScreen> {
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        label: Text(context.translate('logout'), style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w900, fontSize: 16)),
  ...
  Widget _buildLanguageCard() {
    return _buildSectionCard(Icons.language_rounded, context.translate('language'), [
      _buildActionRow(Icons.translate_rounded, LanguageService().currentLanguage, _showLanguageSelector),
    ]);
  }
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      title: Text(l, style: TextStyle(fontSize: 16, fontWeight: isSelected ? FontWeight.w900 : FontWeight.w500, color: isSelected ? const Color(0xFF00BFA5) : const Color(0xFF4A4A4A))),
                      trailing: isSelected ? const Icon(Icons.check_box_rounded, color: Color(0xFF00BFA5)) : Icon(Icons.check_box_outline_blank_rounded, color: Colors.grey.shade300),
                      onTap: () {
