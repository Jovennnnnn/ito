...
class _Verify2FAScreenState extends State<Verify2FAScreen> {
  ...
  void _handleVerify() async {
    ...
    if (otp.length != 6) {
      CustomNotification.showTopNotification(context, context.translate('please_enter_otp'));
      return;
    }
    ...
    try {
      ...
      if (data is Map && data['success'] == true) {
        ...
        if (!mounted) return;
        CustomNotification.showTopNotification(context, context.translate('otp_verify_success'), false);
        ...
        if (!mounted) return;
        String msg = context.translate('error');
  ...
  void _handleResend() async {
    try {
      CustomNotification.showTopNotification(context, context.translate('resend_code'), false);
      await _apiService.forgotPassword(widget.userData['email']);
      if (!mounted) return;
      CustomNotification.showTopNotification(context, context.translate('otp_sent_success'), false);
    } catch (e) {
      if (!mounted) return;
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    context.translate('two_step_verification'),
                  ...
                  Text(
                    '${context.translate('enter_6_digit')}\n${widget.userData['email']}',
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      counterText: "",
                      hintText: context.translate('otp_hint'),
